...
def home(request):
    if request.user.is_authenticated:
        ...
        return render(request, 'bookingapp/signin.html')
...
def findbus(request):
    ...
    if request.method == 'POST':
        ...
        if bus_list:
            return render(request, 'bookingapp/list.html', locals())
        else:
            context["error"] = "Sorry no buses availiable"
            return render(request, 'bookingapp/findbus.html', context)
    else:
        return render(request, 'bookingapp/findbus.html')
    ...
    if request.method == 'POST':
        ...
        if bus:
            if bus.rem > int(seats_r):
                ...
                # book.save()
                return render(request, 'bookingapp/bookings.html', locals())
            else:
...
def cancellings(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'bookingapp/error.html', context)
    else:
        return render(request, 'bookingapp/findbus.html')
...
def seebookings(request,new={}):
    ...
    if book_list:
        return render(request, 'bookingapp/booklist.html', locals())
    else:
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            login(request, user)
            return render(request, 'bookingapp/thank.html')
        else:
            context["error"] = "Provide valid credentials"
            return render(request, 'bookingapp/signup.html', context)
    else:
        return render(request, 'bookingapp/signup.html', context)
...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            return render(request, 'bookingapp/success.html', context)
            # return HttpResponseRedirect('success')
        else:
            context["error"] = "Provide valid credentials"
            return render(request, 'bookingapp/signin.html', context)
    else:
